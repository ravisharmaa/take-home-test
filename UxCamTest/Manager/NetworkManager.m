...
-(void) getData:(NSString *)cityName completion:(void (^)(NSArray * _Nullable, NSError * _Nullable))completion {
    ...
    [[NSURLSession.sharedSession
      ...
      completionHandler:^(NSData * _Nullable data, NSURLResponse * _Nullable response, NSError * _Nullable error) {
        ...
        NSArray *jsonData = [NSJSONSerialization JSONObjectWithData:data options:NSJSONReadingMutableContainers error:&err];
